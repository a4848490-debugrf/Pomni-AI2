...
const client = new Client({
  phoneNumber: '201149336653', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "VA", lid: "966507216387@lid", jid: "972569311531@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "221307316789354@lid", jid: "201144480436@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "201149336653@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 4 
